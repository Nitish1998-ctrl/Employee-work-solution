<%@ Page Title="" Language="C#" MasterPageFile="~/site.master" AutoEventWireup="true" CodeFile="adminschedule.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontent" Runat="Server">
    ...
    <center>
<u  ><b>Schedule Detail</b></u><br /><br />

<asp:GridView ID="scheduledetail" runat="server" AllowPaging="True" 
            ...
            onpageindexchanging="scheduledetail_PageIndexChanging" 
            onrowdeleting="scheduledetail_RowDeleting" >
            <AlternatingRowStyle BackColor="White" />
            <Columns>
                <asp:TemplateField HeaderText="ScheduleId" HeaderStyle-ForeColor="White" HeaderStyle-Font-Size="Small">
                
                <ItemTemplate>
                <b  style="margin-left:30px"  > <%#Eval("scheduleid") %></b>
                </ItemTemplate>
...
<HeaderStyle Font-Size="Small" ForeColor="White"></HeaderStyle>
                ...
                <ItemTemplate>
                <b  style="margin-left:28px" > <%#Eval("s_date") %></b>
                </ItemTemplate>

<HeaderStyle Font-Size="Small" ForeColor="White"></HeaderStyle>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Schedule" HeaderStyle-ForeColor="White" HeaderStyle-Font-Size="Small">
                <ItemTemplate>
